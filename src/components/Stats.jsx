import {calculateCurrentCaffeineLevel, statusLevels,   coffeeConsumptionHistory, calculateCoffeeStats, getTopThreeCoffees } from "../utils";
...
export default function Stats (){
    ...
    return (
        ...
        <thead>
            ...
            <tbody>
                {getTopThreeCoffees(coffeeConsumptionHistory).map((item, itemIndex) =>{
                    return(
                        <tr key={itemIndex}>
